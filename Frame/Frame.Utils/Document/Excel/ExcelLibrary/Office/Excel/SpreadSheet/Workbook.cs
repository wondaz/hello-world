...
using Frame.Utils.ExcelLibrary.CompoundDocumentFormat;
using Frame.Utils.ExcelLibrary.BinaryFileFormat;
using Frame.Utils.ExcelLibrary.BinaryDrawingFormat;

namespace Frame.Utils.ExcelLibrary.SpreadSheet
{
