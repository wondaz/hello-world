...
namespace Frame.Utils.NPOI.Util
{
    using System;
    ...
    /// the header has been written.  The client code can call <see cref="M:Frame.Utils.NPOI.Util.IDelayableLittleEndianOutput.CreateDelayedOutput"/>
