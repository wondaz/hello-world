...
namespace Frame.Utils.NPOI.HSSF.Record
{
    using System;
    using System.Text;
    using Frame.Utils.NPOI.SS.Formula.Eval;
 ...
 */
    internal class SpecialCachedValue
    {
        ...
        public Frame.Utils.NPOI.SS.UserModel.CellType GetValueType()
        {
            int typeCode = GetTypeCode();
            switch (typeCode)
            {
                case STRING: return Frame.Utils.NPOI.SS.UserModel.CellType.STRING;
                case BOOLEAN: return Frame.Utils.NPOI.SS.UserModel.CellType.BOOLEAN;
                case ERROR_CODE: return Frame.Utils.NPOI.SS.UserModel.CellType.ERROR;
                case EMPTY: return Frame.Utils.NPOI.SS.UserModel.CellType.STRING; // is this correct?
            }
    ...
    public class FormulaRecord : CellRecord
    {
        ...
        [NonSerialized]
        private Frame.Utils.NPOI.SS.Formula.Formula field_8_parsed_expr;
...
*/
        ...
        {
            field_8_parsed_expr = Frame.Utils.NPOI.SS.Formula.Formula.Create(Ptg.EMPTY_PTG_ARRAY);
        }
 ...
 */
        ...
        {
            field_8_parsed_expr = Frame.Utils.NPOI.SS.Formula.Formula.Create(ptgs);
        }
        ...
        public Ptg[] ParsedExpression
        {
            ...
            set { field_8_parsed_expr = Frame.Utils.NPOI.SS.Formula.Formula.Create(value); }
        }
        public Frame.Utils.NPOI.SS.Formula.Formula Formula
        {
            get
            {
        ...
        public Frame.Utils.NPOI.SS.UserModel.CellType CachedResultType
        {
            get
            {
                if (specialCachedValue == null)
                {
                    return Frame.Utils.NPOI.SS.UserModel.CellType.NUMERIC;
                }
                return (Frame.Utils.NPOI.SS.UserModel.CellType)specialCachedValue.GetValueType();
            }
        }
