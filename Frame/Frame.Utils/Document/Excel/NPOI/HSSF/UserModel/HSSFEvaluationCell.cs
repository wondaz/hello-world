...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private Frame.Utils.NPOI.SS.UserModel.ICell _cell;

        public HSSFEvaluationCell(Frame.Utils.NPOI.SS.UserModel.ICell cell, IEvaluationSheet evalSheet)
        {
            _cell = cell;
            _evalSheet = evalSheet;
        }
        public HSSFEvaluationCell(Frame.Utils.NPOI.SS.UserModel.ICell cell)
        {
            _cell = cell;
        ...
        {
            Frame.Utils.NPOI.SS.UserModel.ICell cellb = ((HSSFEvaluationCell)obj)._cell;
        ...
        public Frame.Utils.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public Frame.Utils.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
