...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    public class DVConstraint : IDataValidationConstraint
    {
         ...
         * 
         * @param validationType one of {@link Frame.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#ANY},
         * {@link Frame.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#DECIMAL},
         * {@link Frame.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#INTEGER},
         * {@link Frame.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#TEXT_LENGTH}
         * @param comparisonOperator any constant from {@link Frame.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
         ...
         * 
         * @param comparisonOperator constant from {@link Frame.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
        ...
        /* (non-Javadoc)
         * @see Frame.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getValidationType()
         */
        ...
        /* (non-Javadoc)
         * @see Frame.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula1()
         */
        ...
        /* (non-Javadoc)
         * @see Frame.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula2()
         */
