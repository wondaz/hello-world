...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    [Serializable]
    public class HSSFTextbox : HSSFSimpleShape //,Frame.Utils.NPOI.SS.UserModel.ITextbox
    {
    ...
    public static short  VERTICAL_ALIGNMENT_DISTRIBUTED= 7;
        ...
        Frame.Utils.NPOI.SS.UserModel.IRichTextString str = new HSSFRichTextString("");
        ...
        public virtual Frame.Utils.NPOI.SS.UserModel.IRichTextString String
        {
            get { return str; }
            set
