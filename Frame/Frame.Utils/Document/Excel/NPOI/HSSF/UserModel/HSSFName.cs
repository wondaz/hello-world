...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:Frame.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, Frame.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
