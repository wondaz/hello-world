...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,Frame.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, Frame.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(Frame.Utils.NPOI.SS.UserModel.IFont font)
        {
