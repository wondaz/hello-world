...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public Frame.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : Frame.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private Frame.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = Frame.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public Frame.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public Frame.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public Frame.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            Frame.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public Frame.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public Frame.Utils.NPOI.SS.UserModel.Font FindFont(Frame.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 Frame.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, Frame.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public Frame.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                Frame.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public Frame.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public Frame.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public Frame.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public Frame.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public Frame.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public Frame.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public Frame.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, Frame.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case Frame.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case Frame.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case Frame.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case Frame.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case Frame.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case Frame.Utils.NPOI.SS.UserModel.PictureType.DIB:
