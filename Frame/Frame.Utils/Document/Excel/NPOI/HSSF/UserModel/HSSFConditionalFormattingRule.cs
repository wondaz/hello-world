...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    using Frame.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)Frame.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)Frame.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
