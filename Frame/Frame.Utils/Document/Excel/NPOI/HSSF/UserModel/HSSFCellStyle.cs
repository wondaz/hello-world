...
namespace Frame.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCellStyle : ICellStyle
    {
        ...
        private Frame.Utils.NPOI.HSSF.Model.InternalWorkbook workbook = null;
        ...
        /// <param name="rec">The record.</param>
        /// <param name="workbook">The workbook.</param>
        public HSSFCellStyle(short index, ExtendedFormatRecord rec, Frame.Utils.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
        ...
        /// <param name="workbook">The workbook.</param>
        /// <returns></returns>
        public String GetDataFormatString(Frame.Utils.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
            HSSFDataFormat format = new HSSFDataFormat(workbook);
        ...
        public void SetFont(Frame.Utils.NPOI.SS.UserModel.IFont font)
        {
