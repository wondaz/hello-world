...
using System.IO;
using Frame.Utils.NPOI.POIFS.Common;
using Frame.Utils.NPOI.POIFS.Dev;
using Frame.Utils.NPOI.POIFS.NIO;
using Frame.Utils.NPOI.POIFS.Properties;
using Frame.Utils.NPOI.POIFS.Storage;
using Frame.Utils.NPOI.Util;
using Frame.Utils.NPOI.POIFS.EventFileSystem;

namespace Frame.Utils.NPOI.POIFS.FileSystem
{
