...
using Frame.Utils.EPPlus.Utils;
using System.Xml;
using Frame.Utils.EPPlus.DataValidation.Contracts;

namespace Frame.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit Frame.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
