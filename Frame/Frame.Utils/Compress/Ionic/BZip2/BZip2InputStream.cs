...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:Frame.Utils.Ionic.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace Frame.Utils.Ionic.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly Frame.Utils.Ionic.Crc.CRC32 crc = new Frame.Utils.Ionic.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new Frame.Utils.Ionic.BZip2.BZip2InputStream(fs))
        ///       {
