...
// generating zip files.  This class does not depend on Frame.Utils.Ionic.Zip.ZipFile, but rather
...
namespace Frame.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = Frame.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="Frame.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = Frame.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="Frame.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private Frame.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public Frame.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
