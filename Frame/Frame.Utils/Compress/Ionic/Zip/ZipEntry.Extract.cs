...
namespace Frame.Utils.Ionic.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="Frame.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="Frame.Utils.Ionic.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="Frame.Utils.Ionic.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (Frame.Utils.Ionic.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As Frame.Utils.Ionic.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="Frame.Utils.Ionic.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public Frame.Utils.Ionic.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public Frame.Utils.Ionic.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal Frame.Utils.Ionic.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new Frame.Utils.Ionic.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is Frame.Utils.Ionic.Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                Frame.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new Frame.Utils.Ionic.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new Frame.Utils.Ionic.Zlib.DeflateStream(input2, Frame.Utils.Ionic.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new Frame.Utils.Ionic.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = Frame.Utils.Ionic.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
