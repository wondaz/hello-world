...
namespace Frame.Utils.Ionic.Zip
{
    ...
    ///   cref="Frame.Utils.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="Frame.Utils.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="Frame.Utils.Ionic.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="Frame.Utils.Ionic.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="Frame.Utils.Ionic.Zip.ZipFile.SetCompression"/>
    public delegate Frame.Utils.Ionic.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
