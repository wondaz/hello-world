...
namespace Frame.Utils.Ionic.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="Frame.Utils.Ionic.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new Frame.Utils.Ionic.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= Frame.Utils.Ionic.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = Frame.Utils.Ionic.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = Frame.Utils.Ionic.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
