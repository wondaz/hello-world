...
namespace Frame.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Frame.Utils.Ionic.FileSelector ff = new Frame.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace Frame.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(Frame.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Frame.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Frame.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Frame.Utils.Ionic.Zip.ZipEntry> SelectEntries(Frame.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Frame.Utils.Ionic.Zip.ZipEntry>();

            foreach (Frame.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Frame.Utils.Ionic.Zip.ZipEntry> SelectEntries(Frame.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
