...
using Frame.Utils.ZipLib.Encryption;
#endif

using Frame.Utils.ZipLib.Core;
using Frame.Utils.ZipLib.Checksums;
using Frame.Utils.ZipLib.Zip.Compression.Streams;
using Frame.Utils.ZipLib.Zip.Compression;

namespace Frame.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Frame.Utils.ZipLib.Zip.ZipException">
