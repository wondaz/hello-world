...
vms.search = function (vdata) {
    ...
    this.grid1.onClickRow = function () {
        ...
        self.form2.SellOrderCode(row[self.pkey]);
        self.grid2.queryParams($.extend({ _xml: vdata._xml2 }, ko.toJS(self.form2)));
    ...
    this.addClick = function () {
        ...
        addPartsPayItem(row, self.searchClick);
        return true;
    };
};

var addPartsPayItem = function (row, callBack) {
    com.dialog({
        title: "新增收款单",
        width: 550,
        height: 300,
        html: "#addPartsPayItem-template",
