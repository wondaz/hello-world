    ...
    com.dialog({
        ...
        viewModel: function (w) {
            ...
            this.refresh = function () {
                com.ajax({
                    url: '/api/sys4s/menu/getmenubuttons/' + menuCode,
                    type: 'GET',
                    async: false,
                    success: function (d) {
            ...
            this.confirmClick = function () {
                ...
                com.ajax({
                    url: '/api/sys4s/menu/editmenubuttons/' + menuCode,
                    data: ko.toJSON(data),
                    success: function (d) {
                        com.message('success', '保存成功！');
                        self.cancelClick();
