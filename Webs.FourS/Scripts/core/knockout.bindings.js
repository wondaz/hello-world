...
(function ($, ko) {
    ...
    ko.creatEasyuiValueBindings({ type: 'datebox', event: 'onChange', formatter: com.formatDate });
    ...
    ko.creatEasyuiValueBindings({ type: 'datetimespinner', event: 'onChange' });
    ...
    ko.creatEasyuiEnableBindings = function (o) {
        ...
        var customBinding = {
            update: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                $(element)[o.type](o.options(enable), o.value(enable));//$(element)["linkButton"]("Enable",value);给属性赋值
            }
        };
